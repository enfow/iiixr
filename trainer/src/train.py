...
def main():
    ...
    parser.add_argument('--model', type=str, choices=['ppo', 'sac', 'rainbow_dqn'], default='ppo', help='Model to train')
    ...
    if args.model == 'ppo':
        ...
        trainer = RainbowDQNTrainer(env, config, save_dir=f"{args.save_dir}/rainbow_dqn")
    else:

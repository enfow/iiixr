...
- **TD3 Sequential(LSTM)**: TD3 의 Policy Network 에 LSTM 을 적용한 모델
  - [REVIEW](<./td3>) | [PAPER](<https://arxiv.org/abs/1802.09477>) | [CODE](<https://github.com/enfow/iiixr/blob/main/trainer/src/trainer/td3_sequential_lstm_trainer.py>)
- **TD3 Sequential(Transformer)**: TD3 의 Policy Network 에 Transformer 를 적용한 모델
  - [REVIEW](<./td3>) | [PAPER](<https://arxiv.org/abs/1802.09477>) | [CODE](<https://github.com/enfow/iiixr/blob/main/trainer/src/trainer/td3_sequential_transformer_trainer.py>)
